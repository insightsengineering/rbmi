...
#' Invert Samples
#'
#' Takes a sample object created by [impute_data_individual()]
#' and inverts it based upon the original transposition done by
#' [transpose_samples]() in order to group by the
#' sample number instead of the subject ID
#'
#' @param samples A list of "sample" objects created by [impute_data_individual()]
#' @param indexes A list of indexes created by [transpose_samples()]
