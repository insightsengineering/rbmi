...
#' first calculate the marginal (multivariate normal) distribution of a subjects's longitudinal outcome variable
...
#' The `update_strategy` dataframe must contain two columns,
