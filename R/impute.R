...
#' Transpose Samples
#'
#' Transposes samples generated by \code{\link[rbmi]{draw}} so that they are grouped
#' by `subjid` instead of by sample number.
#'
#' @param samples A list of samples generated by \code{\link[rbmi]{draw}}
...
#'
#' @param imputes A list of "sample" objects created by \code{\link[rbmi]{impute_data_individual}}
