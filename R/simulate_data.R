...
#'
#' @description Use this function to provide input arguments for each study group needed to simulate data with [simulate()].
#' [simulate()] generates data for a two-arms clinical trial with longitudinal continuous outcome and two intercurrent events (ICEs).
#'
...
#' @param prob_ice1 Numeric vector that specifies for each visit the probability of experiencing ICE1 after the current visit for a patient with outcome equal to the mean at baseline.
...
#'
#' @details For the details, please see [simulate()].
#'
...
#' - `id`: Factor variable that specifies the patient's id.
#' - `visit`: Factor variable that specifies the visit of each assessment. Visit `0` denotes the baseline visit.
#' - `group`: Factor variable that specifies which treatment group each patient belongs to.
...
#'
#' @export
simulate <- function(pars_c, pars_t, post_ice_traj, strategies = getStrategies()) {
...
#' @param strategy_fun Function implementing trajectories after the intercurrent event (ICE). A named list of functions. Must be one of [getStrategies()]. See [getStrategies()] for details.
#' @param distr_pars_ref Optional. Named list containing the simulation parameters of the reference arm. It contains the following:
...
generate_data_single <- function(pars_group, strategy_fun, distr_pars_ref = NULL) {
    ...
    # ICE2 happens if a patient is on treatment and drops-out
...
#' @param ids TODO
#' @param prob_ice TODO
#' @param or_outcome_ice TODO
#' @param baseline_mean TODO
#'
#' @return TODO
#'
...
#'
#' @param distr_pars_group TODO
#' @param outcome TODO
#' @param ids TODO
#' @param ind_ice TODO
#' @param strategy_fun TODO
#' @param distr_pars_ref TODO
#'
#' @return TODO
#'
...
#' Adjust trajectory of a patient's outcome due to the intercurrent event (ICE)
#'
#' @param distr_pars_group TODO
#' @param outcome TODO
#' @param strategy_fun TODO
