...
Please also note that the names of the analysis estimates contains "ref" and "alt" to refer to the two treatment arms. Here "ref" refers to the first level of `vars$group` which not necessarily
