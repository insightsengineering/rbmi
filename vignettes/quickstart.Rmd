...
The purpose of this vignette is to provide a 15 minute quickstart guide to the core functions of the `rbmi` package. Note that the examples will focus on continuous outcomes; for modeling count outcomes please refer to the [separate vignette](count.html).
