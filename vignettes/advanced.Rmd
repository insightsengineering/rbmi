...
# Management of post-ICE observed values handled with a reference-based assumption
...
The tipping point analysis is a way of doing a sensitivity analysis by repeatedly performing a delta-adjustment with worse and worse value of delta until when the result from the primary analysis is overturned.
