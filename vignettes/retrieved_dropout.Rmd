...
implemented for continuous outcomes in the `rbmi` package .
...
is modelled separately for each treatment arm. This model is similar to the "TV2-MAR" estimator in @Noci2021. Compared to the basic 
...
ind_ice1*group*visit`. This assumes a constant shift in outcomes after the ICE, which is modelled separately for each treatment arm 
