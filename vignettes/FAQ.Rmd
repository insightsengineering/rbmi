...
`rbmi` currently covers only continuous and count outcome data, i.e. settings with 

- a single longitudinal continuous outcome which may be missing at some visits and hence require imputation. 
- a single count outcome which may be missing for some observation periods and hence require imputation.
