...
For the time-homogeneous version of the AR(1) covariance structure, we use a flat prior on the correlation parameter $\rho$ and a scaled inverse chi-squared prior for the variance parameter $\sigma^2$, as described above.
