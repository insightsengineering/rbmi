...
* The corresponding new `scale` argument in `print.pool()` and `as.data.frame.pool()` methods allows to choose the original or transformed scale to look at for the pooled results.
